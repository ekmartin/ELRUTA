...
module.exports = function(app) {
  ...
  /* Demo steinkjer API */
  app.get('/api/demo-steinkjer.json', function(req, res){
  ...
  app.get('/api/demo-steinkjer-general.json', function(req, res){

    var meter = req.param('meter');

    var dateFrom = '2013-03-20';
    var dateTo = '2014-03-20';

    request.post('https://api.demosteinkjer.no/meters/' + meter)
      .auth('da89bc51d99942e296ff69b0d0fa5782', '46dee7e281e748d097afea9c3f5d1ed2')
      .send('seriesType=ActivePlus')
      .send('dateFrom=' + dateFrom)
      .send('dateTo=' + dateTo)
      .send('intervalType=Month')
      .end(function(api){
            ...
            .end(function(json){
              ...
              if (json.status != 202) {
                ...
                res.send({
                  ...
                  usageLastYear: readings[readings.length-1].value - readings[0].value
                });
